...
module github.com/denggeng/openai-agents-go-plus
...
require (
	...
	github.com/redis/go-redis/v9 v9.99.8
...
require (
	...
	github.com/nacos-group/nacos-sdk-go/v2 v2.999.4 // indirect
	...
	gopkg.inshopline.com/commons/configx v1.0.6-rc.2 // indirect
