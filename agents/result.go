...
func (r *RunResult) ReleaseAgents(releaseNewItems ...bool) {
	...
	if releaseItems {
		...
		releaseRunItemAgents(r.ModelInputItems)
	}
	r.LastAgent = nil
}
...
type RunResultStreaming struct {
	...
	modelInputItems            *atomic.Pointer[[]RunItem]
...
func newRunResultStreaming(ctx context.Context) *RunResultStreaming {
	return &RunResultStreaming{
		...
		modelInputItems:            newZeroValAtomicPointer[[]RunItem](),
...
func (r *RunResultStreaming) ModelInputItems() []RunItem { return *r.modelInputItems.Load() }
func (r *RunResultStreaming) setModelInputItems(v []RunItem) {
	r.modelInputItems.Store(&v)
}
